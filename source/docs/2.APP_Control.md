...
<p>To participate in this game, you must build the corresponding Lego model. For instructions on how to construct it, please refer to the <strong><a href="https://docs.hiwonder.com/projects/MechDog/en/latest/docs/4.Python_Programming_Projects.html#lego-model-games">4.Python Programming Projects->4.7 LEGO Model Games</a></strong> Additionally, you will need to download the relevant mobile app control program.</p></td>
</tr>
</tbody>
</table>
