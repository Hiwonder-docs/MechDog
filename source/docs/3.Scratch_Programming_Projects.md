...
<img class="common_img" src="../_static/media/chapter_3/section_2/01/media/image4.png"  />

② All four legs touch the ground simultaneously, with legs 1, 2, 3, and 4 all providing support.

<img class="common_img" src="../_static/media/chapter_3/section_2/01/media/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/01/media/image6.png"  />

④ Finally, legs 2 and 3 also touch the ground, along with legs 1 and 4, completing one walking gait cycle.

<img class="common_img" src="../_static/media/chapter_3/section_2/01/media/image7.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/02/media/image2.png"   />

* **Example Program**

[Forward and Backward Program.sb3]()

(1) Begin by waiting for 2 seconds to allow users to place MechDog in the appropriate position before running the program.

<img class="common_img" src="../_static/media/chapter_3/section_2/02/media/image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/02/media/image4.png"  />

(3) Set the stride and angle to 0 to stop movement, then delay for 2 seconds.

<img class="common_img" src="../_static/media/chapter_3/section_2/02/media/image5.png"  />

(4) Set the stride to -50, indicating a backward movement of 50 millimeters, delay for 5 seconds.

<img class="common_img" src="../_static/media/chapter_3/section_2/02/media/image6.png"  />

(5) Stop movement, delay for 2 seconds.

<img class="common_img" src="../_static/media/chapter_3/section_2/02/media/image7.png"  />

Complete Code:

<img class="common_img" src="../_static/media/chapter_3/section_2/02/media/image8.png"  />

* **Program Download**

[Forward and Backward Program.sb3]()

(1) Open WonderCode software<img  src="../_static/media/chapter_3/section_2/02/media/image9.png"  />

(2) Drag the [Forward and Backward Program.sb3]() file located in the same path as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_2/02/media/image10.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/02/media/image11.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_2/02/media/image12.png"  />

(4) Click on <img src="../_static/media/chapter_3/section_2/02/media/image13.png"  /> on the right to download the program into MechDog. Wait for the successful download prompt.

<img class="common_img" src="../_static/media/chapter_3/section_2/02/media/image14.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/03/media/image2.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/03/media/image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/03/media/image4.png"  />

(3) Set the stride and angle to 0 to stop movement, then delay for 2 seconds.

<img class="common_img" src="../_static/media/chapter_3/section_2/03/media/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/03/media/image6.png"  />

(5) Stop movement, delay for 2 seconds.

<img class="common_img" src="../_static/media/chapter_3/section_2/03/media/image7.png"  />

Complete Code:

<img class="common_img" src="../_static/media/chapter_3/section_2/03/media/image8.png"  />

* **Program Download**

[Turn Program.sb3]()

(1) Open WonderCode software <img  src="../_static/media/chapter_3/section_2/03/media/image9.png"  />

(2) Drag the [Turn Program.sb3]() file located in the same path as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_2/03/media/image10.png"  />

(3) Click on the menu bar "**Connect**" and select the appropriate COM port. For example, use COM7. Upon successful connection, a "**Connection Successful**" message will appear.

<img class="common_img" src="../_static/media/chapter_3/section_2/03/media/image11.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_2/03/media/image12.png"  />

(4) Click on <img src="../_static/media/chapter_3/section_2/03/media/image13.png"  /> on the right to download the program into MechDog. Wait for the successful download prompt.

<img class="common_img" src="../_static/media/chapter_3/section_2/03/media/image14.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/04/media/image2.png"   />

* **Example Program**

[Speed Adjustment Program.sb3]()

(1) Initialize MechDog's posture (standing posture) and set the initial stride to 40, then delay for 1 second.

<img class="common_img" src="../_static/media/chapter_3/section_2/04/media/image3.png"  />

(2) When the button is short-pressed, set the press flag to 1.

<img class="common_img" src="../_static/media/chapter_3/section_2/04/media/image4.png"  />

(3) In the main program, repeat the following code:

Check if the button press flag is set.

<img class="common_img" src="../_static/media/chapter_3/section_2/04/media/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/04/media/image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/04/media/image7.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_2/04/media/image8.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_2/04/media/image9.png"  />

* **Program Download**

[Speed Adjustment Program.sb3]()

(1) Open WonderCode software <img src="../_static/media/chapter_3/section_2/04/media/image10.png"  />.

(2) Drag the [Speed Adjustment Program.sb3]() file located in the same path as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_2/04/media/image11.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/04/media/image12.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_2/04/media/image13.png"  />

(4) Click on <img  src="../_static/media/chapter_3/section_2/04/media/image14.png"  /> on the right to download the program into MechDog. Wait for the successful download prompt.

<img class="common_img" src="../_static/media/chapter_3/section_2/04/media/image15.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_2\05\media\image2.png"   />

* **Example Program**

[Stepping in Place Program.sb3]()

(1) Initialize MechDog's posture (standing posture) and delay for 2 seconds.

<img class="common_img" src="../_static/media/chapter_3\section_2\05\media\image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_2\05\media\image4.png"  />

(3) Finally, stop MechDog.

<img class="common_img" src="../_static/media/chapter_3\section_2\05\media\image5.png"  />

Complete Code:

<img class="common_img" src="../_static/media/chapter_3\section_2\05\media\image6.png"  />

* **Program Download**

[Stepping in Place Program.sb3]()

(1) Open WonderCode software <img class="common_img" src="../_static/media/chapter_3\section_2\05\media\image7.png"  />.

(2) Drag the "**Stepping in Place Program.sb3**" file located in the same path as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3\section_2\05\media\image8.png"  />

(3) Click on the menu bar "**Connect**" and select the appropriate COM port. For example, use COM7. Upon successful connection, a "**Connection Successful**" message will appear.

<img class="common_img" src="../_static/media/chapter_3\section_2\05\media\image9.png"  />

<img class="common_img" src="../_static/media/chapter_3\section_2\05\media\image10.png"  />

(4) Click on <img class="common_img" src="../_static/media/chapter_3\section_2\05\media\image11.png"  /> on the right to download the program into MechDog. Wait for the successful download prompt.

<img class="common_img" src="../_static/media/chapter_3\section_2\05\media\image12.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_2\06\media\image2.png"   />

* **Example Program**

[Gait Parameter Adjustment Program.sb3]()

(1) Initialize MechDog's posture (i.e., standing posture) and delay for 2 seconds.

<img class="common_img" src="../_static/media/chapter_3\section_2\06\media\image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_2\06\media\image4.png"  />

(3) Make MechDog stop for 3 seconds.

<img class="common_img" src="../_static/media/chapter_3\section_2\06\media\image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_2\06\media\image6.png"  />

(5) Make MechDog stop.

<img class="common_img" src="../_static/media/chapter_3\section_2\06\media\image7.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3\section_2\06\media\image8.png"  />

* **Program Download**

[Gait Parameter Adjustment Program.sb3]()

(1) Open WonderCode software <img src="../_static/media/chapter_3\section_2\06\media\image9.png"  />

(2) Drag the "**Gait Parameter Adjustment Program.sb3**" file located in the same path as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3\section_2\06\media\image10.png"  />

(3) Click on the menu bar "**Connect**" and select the appropriate COM port. For example, use COM3. Upon successful connection, a "**Connection Successful**" message will appear.

<img class="common_img" src="../_static/media/chapter_3\section_2\06\media\image11.png"  />

<img class="common_img" src="../_static/media/chapter_3\section_2\06\media\image12.png"  />

(4) Click on <img  src="../_static/media/chapter_3\section_2\06\media\image13.png"  /> on the right to download the program into MechDog. Wait for the successful download prompt.

<img class="common_img" src="../_static/media/chapter_3\section_2\06\media\image14.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/07/media/image2.png"   />

* **Example Program**

[Walking Height Adjustment Program.sb3]()

(1) Initialize MechDog's posture (i.e., standing posture, height of 80 millimeters) and delay for 2 seconds.

<img class="common_img" src="../_static/media/chapter_3/section_2/07/media/image3.png"  />

(2) Have MechDog move forward with a stride length of 50 millimeters in its normal posture for 5 seconds.

<img class="common_img" src="../_static/media/chapter_3/section_2/07/media/image4.png"  />

(3) Next, while moving forward, raise its body by 20 millimeters over a period of 1000 milliseconds (i.e., 1 second).

<img class="common_img" src="../_static/media/chapter_3/section_2/07/media/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/07/media/image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/07/media/image7.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3/section_2/07/media/image8.png"  />

* **Program Download**

[Walking Height Adjustment Program.sb3]()

(1) Open WonderCode software <img  src="../_static/media/chapter_3/section_2/07/media/image9.png"  />.

(2) Drag the "**Walking Height Adjustment Program.sb3**" file located in the same path as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_2/07/media/image10.png"  />

(3) Click on the menu bar "**Connect**" and select the appropriate COM port. For example, use COM3. Upon successful connection, a "**Connection Successful**" message will appear.

<img class="common_img" src="../_static/media/chapter_3/section_2/07/media/image11.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_2/07/media/image12.png"  />

(4) Click on <img  src="../_static/media/chapter_3/section_2/07/media/image13.png"  /> on the right to download the program into MechDog. Wait for the successful download prompt.

<img class="common_img" src="../_static/media/chapter_3/section_2/07/media/image14.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/08/media/image2.png"   />

* **Example Program**

[Standing Angle Adjustment Program.sb3]()

(1) Initialize MechDog's posture (i.e., standing posture) and delay for 2 seconds.

<img class="common_img" src="../_static/media/chapter_3/section_2/08/media/image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/08/media/image4.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/08/media/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/08/media/image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_2/08/media/image7.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3/section_2/08/media/image8.png"  />

* **Program Download**

[Standing Angle Adjustment Program.sb3]()

(1) Open WonderCode software <img  src="../_static/media/chapter_3/section_2/08/media/image9.png"  />.

(2) Drag the [Standing Angle Adjustment Program.sb3]() file located in the same path as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_2/08/media/image10.png"  />

(3) Click on the menu bar "**Connect**" and select the appropriate COM port. For example, use COM7. Upon successful connection, a "**Connection Successful**" message will appear.

<img class="common_img" src="../_static/media/chapter_3/section_2/08/media/image11.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_2/08/media/image12.png"  />

(4) Click on <img src="../_static/media/chapter_3/section_2/08/media/image13.png"  /> on the right to download the program into MechDog. Wait for the successful download prompt.

<img class="common_img" src="../_static/media/chapter_3/section_2/08/media/image14.png"  />
...
[Action Group Execution Program.sb3]()

(1) Initialize the posture of MechDog to make it stand on all four legs.

<img class="common_img" src="../_static/media/chapter_3/section_3/01/media/image2.png"  />

(2) In the main program, we let MechDog perform an action sequence. Here, we take the left kick as an example.

<img class="common_img" src="../_static/media/chapter_3/section_3/01/media/image3.png"  />

* **Program Download**

[Action Group Execution Program.sb3]()

(1) Open the WonderCode software <img src="../_static/media/chapter_3/section_3/01/media/image4.png"  />.

(2) Drag the [Action Group Execution Program.sb3]() file from the same path as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_3/01/media/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/01/media/image6.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_3/01/media/image7.png"  />

(4) Once connected, click <img src="../_static/media/chapter_3/section_3/01/media/image8.png"  /> on the right to download the program to MechDog. Wait for the download to complete.

<img class="common_img" src="../_static/media/chapter_3/section_3/01/media/image9.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image2.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image3.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image4.png"   />

* **Example Program**

[Touch Control Program.sb3]()

(1) Initialize MechDog’s posture and configure the flag variables for buttons and actions.

<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image5.png"  />

(2) When the touch sensor is activated, set the button flag variable to 1.

<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image6.png"  />

(3) In the main program, check if the button flag variable is 1. If it is, proceed to execute the action sequence.

<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image7.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image9.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image10.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image11.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image12.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image13.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image14.png"  />

* **Program Download**

[Touch Control Program.sb3]()

(1) Open the WonderCode software <img src="../_static/media/chapter_3/section_3/02/media/image15.png"  />.

(2) Drag the [Touch Control Program.sb3]() file from the same path as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image16.png"  />

(3) Click "**Connect**" in the menu bar, select the COM port (e.g., COM3), and a "**Connection Successful**" message will appear upon successful connection.

<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image17.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image18.png"  />

(4) Once connected, click <img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image19.png"  /> on the right to download the program to MechDog. Wait for the download to complete.

<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image20.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image21.png"  />

(2) Users can customize the action groups as desired. After making changes, follow the instructions in [Program Download]() to run the updated program.

<img class="common_img" src="../_static/media/chapter_3/section_3/02/media/image22.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image2.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image3.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image4.png"   />

* **Example Program**

[Light Sensing Program.sb3]()

(1) Initialize the brightness threshold to 100 for comparison with the brightness value.

<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image5.png"  />

(2) In the main program, read the brightness value from the light sensor and print the value in the information display box.

<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image7.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image8.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image9.png"  />

* **Program Download**

[Light Sensing Program.sb3]()

(1) Open the WonderCode software <img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image10.png"  />

(2) Drag the [Light Sensing Program.sb3]() file from the same path as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image11.png"  />

(3) Click "**Connect**" in the menu bar, select the COM port (e.g., COM3), and a "**Connection Successful**" message will appear upon successful connection.

<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image12.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image13.png"  />

(4) Once connected, click <img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image14.png"  /> on the right to download the program to MechDog. Wait for the download to complete.

<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image15.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image16.png"  />

(2) If the ambient light is weak, decrease the threshold value.

<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image17.png"  />

(3) If the ambient light is strong, increase the threshold value.

<img class="common_img" src="../_static/media/chapter_3/section_3/03/media/image18.png"  />

(4) After making adjustments, follow the instructions in [Program Download]() to run the updated program.
...
<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image2.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image3.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image4.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image5.png"  />

(2) When MechDog's onboard button is pressed, set btn_flag to 1.

<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image6.png"  />

(4) In the main function, set the MP3 module to play track number 16. If btn_flag is 1, start playing the selected music.

<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image7.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image8.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image9.png"  />
...
(1) Launch the WonderCode software <img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image10.png"  />.

(2) Drag the "**Sing and Dance.sb3**" file from the same path as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image11.png"  />

(3) Click "**Connect**" in the menu bar, select the COM port (e.g., COM3), and a "**Connection Successful**" message will appear upon successful connection.

<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image12.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image13.png"  />

(4) Once connected, click <img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image14.png"  /> on the right to download the program to MechDog. Wait for the download to complete.

<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image15.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image16.png"  />

(2) Change the number 16 to 17 to set the MP3 module to play the track with ID 17 by default.

<img class="common_img" src="../_static/media/chapter_3/section_3/04/media/image17.png"  />
...
<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image2.png"   />
...
<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image3.png"   />
...
<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image4.png"   />
...
<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image5.png"   />

* **Example Program**

[Ultrasonic Ranging + Dot Matrix Display Program.sb3]()
...
<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image6.png"  />
...
<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image7.png"  />
...
<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image8.png"  />

(4) If the detected distance is greater than 40 cm, set the RGB light of the ultrasonic module to blue.

<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image9.png"  />

(5) When the distance is between 15 cm and 40 cm, set the RGB light of the ultrasonic module to yellow.

<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image10.png"  />

Complete Code:

<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image11.png"  />

* **Program Download**

[Ultrasonic Ranging + Dot Matrix Display Program.sb3]()

(1) Open the WonderCode software <img src="../_static/media//chapter_3\section_3\05/media/image12.png"  />

(2) Drag the [Ultrasonic Ranging + Dot Matrix Display Program.sb3]() file from the same path as this document into WonderCode.

<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image13.png"  />

(3) Click "**Connect**" in the menu bar, select the COM port (e.g., COM3), and a "**Connection Successful**" message will appear upon successful connection.

<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image14.png"  />

<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image15.png"  />

(4) Once connected, click <img  src="../_static/media//chapter_3\section_3\05/media/image16.png"  /> on the right to download the program to MechDog. Wait for the download to complete.

<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image17.png"  />
...
<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image18.png"  />

(2) Users can choose the color of the RGB light themselves.

<img class="common_img" src="../_static/media//chapter_3\section_3\05/media/image19.png"  />

(3) After making the changes, follow the instructions in [Program Download]() to run the updated program.
...
<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image2.png"   />

(1) Module Introduction

This module uses an IIC communication interface to read distances measured by the ultrasonic sensor via IIC communication. It features two RGB lights integrated into the ultrasonic probe, allowing for brightness adjustment and multi-color effects through variations and mixing of the red (R), green (G), and blue (B) color channels.

<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image3.png"   />
...
[Ultrasonic Alarm Program.sb3]()

(1) Initialize MechDog's posture to make it stand on all four legs.

<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image4.png"  />
...
<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image5.png"  />

(3) If the detected distance is greater than 50 cm, set the RGB light of the ultrasonic module to green.

<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image6.png"  />
...
<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image7.png"  />
...
<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image8.png"  />

Complete Code:

<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image9.png"  />

* **Program Download**

[Ultrasonic Alarm Program.sb3]()

(1) Open the WonderCode software <img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image10.png"  />.

(2) Drag the [Ultrasonic Alarm Program.sb3]() file from the same path as this document into WonderCode.

<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image11.png"  />

(3) Click "**Connect**" in the menu bar, select the COM port (e.g., COM3), and a "**Connection Successful**" message will appear upon successful connection.

<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image12.png"  />

<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image13.png"  />

(4) Once connected, click <img  src="../_static/media//chapter_3\section_3\06\media\image14.png"  /> on the right to download the program to MechDog. Wait for the download to complete.

<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image15.png"  />
...
<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image16.png"  />

(2) For example, to increase the alarm distance, users can modify the “**Distance Value**” according to their needs.

<img class="common_img" src="../_static/media//chapter_3\section_3\06\media\image17.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_3\07\media\image2.png"   />
...
<img class="common_img" src="../_static/media/chapter_3\section_3\07\media\image3.png"  />
...
[Self Balancing Program.sb3]() 

(1) Initialize MechDog's posture to make it stand on all four legs.

<img class="common_img" src="../_static/media/chapter_3\section_3\07\media\image4.png"  />

(2) In the main program, we set the RGB color of the ultrasonic module to yellow and enabled MechDog’s self-balancing mode.

<img class="common_img" src="../_static/media/chapter_3\section_3\07\media\image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_3\07\media\image6.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3\section_3\07\media\image7.png"  />

* **Program Download**

[Self Balancing Program.sb3]() 

(1) Open the WonderCode software <img  src="../_static/media/chapter_3\section_3\07\media\image8.png"  />.

(2) Drag the [Self Balancing Program.sb3]() file from the same path as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3\section_3\07\media\image9.png"  />

(3) Click "**Connect**" in the menu bar, select the COM port (e.g., COM3), and a "**Connection Successful**" message will appear upon successful connection.

<img class="common_img" src="../_static/media/chapter_3\section_3\07\media\image10.png"  />

<img class="common_img" src="../_static/media/chapter_3\section_3\07\media\image11.png"  />

(4) Once connected, click <img src="../_static/media/chapter_3\section_3\07\media\image12.png"  /> on the right to download the program to MechDog. Wait for the download to complete.

<img class="common_img" src="../_static/media/chapter_3\section_3\07\media\image13.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_4/01/media/image2.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_4/01/media/image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_4\02\media\image7.png"  />
...
<img src="../_static/media/chapter_3/section_4/02/media/image8.png"   />
...
<img class="common_img" src="../_static/media/chapter_3\section_4\03\media\image2.png"   />

* **Module Introduction**

<img class="common_img" src="../_static/media/chapter_3\section_4\03\media\image3.png"   />
...
<img class="common_img" src="../_static/media/chapter_3\section_4\03\media\image4.png"   />

* **Example Program**

[Distance Ranging & Announcement Program.sb3]()
...
<img class="common_img" src="../_static/media/chapter_3\section_4\03\media\image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_4\03\media\image6.png"  />

(3) If the distance is greater than 10 cm, set the ultrasonic sensor's light to green.

<img class="common_img" src="../_static/media/chapter_3\section_4\03\media\image7.png"  />

Complete Code:

<img class="common_img" src="../_static/media/chapter_3\section_4\03\media\image8.png"  />

* **Program Download**

[Distance Ranging & Announcement Program.sb3]()

(1) Open the **WonderCode** software <img  src="../_static/media/chapter_3\section_4\03\media\image9.png"  />.

(2) Drag the “**Distance Ranging & Announcement Program.sb3**” file, located in the same directory as this document, into **WonderCode**.

<img class="common_img" src="../_static/media/chapter_3\section_4\03\media\image10.png"   />
...
<img class="common_img" src="../_static/media/chapter_3\section_4\03\media\image11.png"  />

<img class="common_img" src="../_static/media/chapter_3\section_4\03\media\image12.png"  />

(4) Click **Upload** <img   src="../_static/media/chapter_3\section_4\03\media\image13.png"  /> on the right to download the program to **MechDog**. Wait for the download confirmation message.

<img class="common_img" src="../_static/media/chapter_3\section_4\03\media\image14.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_4\04\media\image2.png"   />

* **Module Introduction**

<img class="common_img" src="../_static/media/chapter_3\section_4\04\media\image3.png"   />

The WonderEcho voice interaction module is based on the CI1302 chip, enabling voice recognition and broadcasting. It supports offline neural network acceleration and hardware-accelerated voice signal processing. Through advanced deep noise reduction and neural network analysis, the module delivers accurate recognition results.

Module Connection: Connect the voice interaction module to I2C Port 1 on the MechDog.

<img class="common_img" src="../_static/media/chapter_3\section_4\04\media\image4.png"   />

* **Example Program**

[Human-Robot Interaction Program.sb3]()

(1) Initialize the **distance** variable to 0 and set the voice interaction module interface to **Interface 1**. Then, adjust **MechDog's posture** so that it stands on all four legs.

<img class="common_img" src="../_static/media/chapter_3\section_4\04\media\image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_4\04\media\image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_4\04\media\image7.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3\section_4\04\media\image8.png"  />

* **Program Download**

[Human-Robot Interaction Program.sb3]()

(1) Open WonderCode software <img src="../_static/media/chapter_3\section_4\04\media\image9.png"  />.

(2) Drag the [Human-Robot Interaction Program.sb3]() file, located in the same directory as this document, into **WonderCode**.

<img class="common_img" src="../_static/media/chapter_3\section_4\04\media\image10.png"   />

(3) Click the **“Connect device”** menu and select the appropriate **COM port** (e.g., COM7). Once the connection is established, a **“Connection Successful”** message will appear.

<img class="common_img" src="../_static/media/chapter_3\section_4\04\media\image11.png"   />

<img class="common_img" src="../_static/media/chapter_3\section_4\04\media\image12.png"   />

(4) Click **Upload** <img src="../_static/media/chapter_3\section_4\04\media\image13.png"  /> on the right to download the program to **MechDog**. Wait for the download confirmation message.

<img class="common_img" src="../_static/media/chapter_3\section_4\04\media\image14.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image2.png"   />

* **Module Introduction**

<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image3.png"   />

The WonderEcho voice interaction module is based on the CI1302 chip, enabling voice recognition and broadcasting. It supports offline neural network acceleration and hardware-accelerated voice signal processing. Through advanced deep noise reduction and neural network analysis, the module delivers accurate recognition results.

Module Connection: Connect the voice interaction module to I2C Port 1 on the MechDog.

<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image4.png"   />

* **Example Program**

(1) Initialize the **distance** variable to 0 and set the voice interaction module interface to **Interface 1**. Then, adjust **MechDog's posture** so that it stands on all four legs.

<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image7.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image8.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image9.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image10.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image11.png"  />

* **Program Download**

 [Voice Control Program.sb3]() 

(1) Open WonderCode software <img src="../_static/media/chapter_3/section_4/05/media/image12.png"  />.

(2) Drag the [Voice Control Program.sb3]() file, located in the same directory as this document, into **WonderCode**.

<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image13.png"   />

(3) Click the **“Connect device”** menu and select the appropriate **COM port** (e.g., COM7). Once the connection is established, a **“Connection Successful”** message will appear.

<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image14.png"   />

<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image15.png"   />

(4) Click **Upload** <img src="../_static/media/chapter_3/section_4/05/media/image16.png"  /> on the right to download the program to **MechDog**. Wait for the download confirmation message.

<img class="common_img" src="../_static/media/chapter_3/section_4/05/media/image17.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/01/media/image2.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image2.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image3.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image4.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image5.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image6.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image7.png"  />

③ Select the **“ESP32S3 Dev Module”** development board.

<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image9.png"  />

⑤ Click <img   src="../_static/media/chapter_3/section_5/02/media/image10.png"  /> to upload the code to the ESP32-S3, and wait for the flashing process to complete.

<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image11.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image12.png"  />

(2) Scratch Program Download

[Color Recognition Program.sb3]()

① Open WonderCode software <img src="../_static/media/chapter_3/section_5/02/media/image13.png"  />.

② Drag the [Color Recognition Program.sb3]() file located in the same directory as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image14.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image15.png"   />

<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image16.png"  />

④ After a successful connection, click <img src="../_static/media/chapter_3/section_5/02/media/image17.png"  /> on the right side to download the program to MechDog. Wait for the prompt indicating that the download is complete.

<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image18.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/02/media/image19.png"   />

This example uses yellow, but you can also modify it to recognize other colors such as black.

(2) After making the changes, refer to [Program Download ->(2) Scratch Program Download]() to run the updated program.
...
<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image2.png"   />

* **Module Introduction**

The ESP32-S3 Vision Module is a compact camera module that can function as a standalone system.

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image3.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image4.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image5.png"  />

(2) In the main function, repeat the following steps:

Step1：Obtain the list of blue color data detected by the vision module.

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image7.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image9.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image10.png"  />

Get the width (w) and height (h) of the blue object and calculate its area.

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image11.png"  />

If the area \> 5000, it means MechDog is very close to the object, so MechDog should stop.

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image12.png"  />

Otherwise, set MechDog to move forward or backward based on the value of the `dir` variable.

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image13.png"  />

If blue is not detected, stop MechDog.

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image14.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image15.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image16.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image17.png"  />

③ Select the **“ESP32S3 Dev Module”** development board.

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image18.png"  />

④ Click on the **"Tools"** in the menu bar, and select the corresponding ESP32S3 development board configuration as shown in the figure below (configuration is required for the first use, and no further configuration is needed for subsequent uses).

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image19.png"  />

⑤ Click <img   src="../_static/media/chapter_3/section_5/03/media/image20.png"  /> to upload the code to the ESP32-S3, and wait for the flashing process to complete.

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image21.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image22.png"  />

(2) Scratch Program Download

[Color Tracking Program.sb3]()

① Open WonderCode software <img  src="../_static/media/chapter_3/section_5/03/media/image23.png"  />

② Drag the [Color Tracking Program.sb3]() file located in the same directory as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image24.png"  />

③ Click on the “**Connect**” option in the menu bar and select the appropriate COM port (e.g., COM7). Once connected successfully, you will see a “**Connection Successful**” message.

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image25.png"   />

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image26.png"  />

④ After a successful connection, click <img   src="../_static/media/chapter_3/section_5/03/media/image27.png"  /> on the right side to download the program to MechDog. Wait for the prompt indicating that the download is complete.

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image28.png"  />
...
(1) First, open the **"HSV.exe"** file located at  [Appendix->Color Threshold Adjustment Tool\HSV\HSV.dist\HSV.exe]().

<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image29.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_5/03/media/image30.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image2.png"   />

* **Module Introduction**

The ESP32-S3 Vision Module is a compact camera module that can function as a standalone system.

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image3.png"   />
...
<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image4.png"   />

* **Example Program**

(1) Initialize MechDog's posture (standing position), turn off the ultrasonic lights, and set the visual module interface to 1.

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image7.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image8.png"  />

If both `center1X` and `center1Y` are zero, it means no valid line is recognized, so skip and proceed to the next step.

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image9.png"  />

If `center1X < 60`, the line is on the left side of the visual module, so make MechDog turn left.

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image10.png"  />

If `center1X > 100`, the line is on the right side of the visual module, so make MechDog turn right.

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image11.png"  />

If `60 < center1X < 100`, the line is in the middle of the visual module, so make MechDog move forward.

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image12.png"  />

Complete code：

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image13.png"  />

* **Program Download**

(1) ESP32-S3 Firmware Flashing

[ESP32-S3 Vision Line Following Program]()

① Connect the ESP32-S3 to your computer using a Type-C data cable.

② Open **" ESP32-S3 Vision Line Following Program->LineTracking.ino"** located in the same directory.

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image14.png"  />

③ Select the “ESP32S3 Dev Module” development board.

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image15.png"  />

④ Click on the **"Tools"** in the menu bar, and select the corresponding ESP32S3 development board configuration as shown in the figure below (configuration is required for the first use, and no further configuration is needed for subsequent uses).

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image16.png"  />

⑤ Click <img   src="../_static/media/chapter_3\section_5\04\media\image17.png"  /> to upload the code to the ESP32-S3, and wait for the flashing process to complete.

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image18.png"  />

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image19.png"  />

(2) Scratch Program Download

[Vision Line Following Program.sb3]()

① Open WonderCode software <img src="../_static/media/chapter_3\section_5\04\media\image20.png"  />.

② Drag the [Vision Line Following Program.sb3]() file located in the same directory as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image21.png"  />

③ Click on the “**Connect**” option in the menu bar and select the appropriate COM port (e.g., COM7). Once connected successfully, you will see a “**Connection Successful**” message.

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image22.png"   />

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image23.png"  />

④ After a successful connection, click <img src="../_static/media/chapter_3\section_5\04\media\image24.png"  /> on the right side to download the program to MechDog. Wait for the prompt indicating that the download is complete.

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image25.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image26.png"  />

(2) As an example, to change the line color to red, modify the settings accordingly. You can also change it to other colors.

<img class="common_img" src="../_static/media/chapter_3\section_5\04\media\image27.png"  />

(3) After making the changes, refer to "5.1 Scratch Program Download" to run it.
...
<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image2.png"   />

* **Module Introduction**

The ESP32-S3 Vision Module is a compact camera module that can function as a standalone system.

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image3.png"   />
...
<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image4.png"   />

* **Example Program**

(1) Initialize MechDog’s posture (standing position) and set the visual module interface to 1.

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image5.png"  />

(2) In the main function, repeatedly execute the following steps:

Step1: Check if the vision module detects a face. If a face is detected, execute the “bowing” action group.

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image6.png"  />

Step2: If no face is detected, stop the action group.

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image7.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image8.png"  />

* **Program Download**

(1) ESP32-S3 Firmware Flashing

[ESP32-S3 Face Recognition Program]()

① Connect the ESP32-S3 to your computer using a Type-C data cable.

② Open [ESP32-S3 Face Recognition Program->FaceDetection.ino]() located in the same directory.

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image9.png"  />

③ Select the **“ESP32S3 Dev Module”** development board.

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image10.png"  />

④ Click on the **"Tools"** in the menu bar, and select the corresponding ESP32S3 development board configuration as shown in the figure below (configuration is required for the first use, and no further configuration is needed for subsequent uses).

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image11.png"  />

⑤ Click <img src="../_static/media/chapter_3\section_5\05\media\image12.png"  /> to upload the code to the ESP32-S3, and wait for the flashing process to complete.

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image13.png"  />

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image14.png"  />

(2) Scratch Program Download

[Face Recognition Program.sb3]()

① Open WonderCode software <img src="../_static/media/chapter_3\section_5\05\media\image15.png"  />.

② Drag the [Face Recognition Program.sb3]() file located in the same directory as this document into WonderCode.

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image16.png"  />

③ Click on the “**Connect**” option in the menu bar and select the appropriate COM port (e.g., COM7). Once connected successfully, you will see a “**Connection Successful**” message.

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image17.png"   />

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image18.png"  />

④ After a successful connection, click <img src="../_static/media/chapter_3\section_5\05\media\image19.png"  /> on the right side to download the program to MechDog. Wait for the prompt indicating that the download is complete.

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image20.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image21.png"  />

(2) Here, changing the action group to '**handshake**' is used as an example. Users can also modify it to other action groups.

<img class="common_img" src="../_static/media/chapter_3\section_5\05\media\image22.png"  />

(3) After making the changes, refer to [Program Download -> Scratch Program Download]() to run it.
...
<img class="common_img" src="../_static/media/chapter_3\section_7\01\media\image2.png"   />

* **Program Analysis**

[Ball Launcher Program.sb3]()

(1) In the main program, initialize the servo and wait for 2 seconds. This allows you to place the ball into the launcher.

<img class="common_img" src="../_static/media/chapter_3\section_7\01\media\image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_7\01\media\image4.png"  />

(3) Set the stride and angle to 0 to stop the movement. Delay for 0.5 seconds.

<img class="common_img" src="../_static/media/chapter_3\section_7\01\media\image5.png"  />

(4) After stopping, MechDog executes the crouching action.

<img class="common_img" src="../_static/media/chapter_3\section_7\01\media\image6.png"  />

(5) Control the servo to launch the ball.

<img class="common_img" src="../_static/media/chapter_3\section_7\01\media\image7.png"  />

(6) After the launch action is completed, control the servo to return to the initial position.

<img class="common_img" src="../_static/media/chapter_3\section_7\01\media\image8.png"  />

(7) Return MechDog to its initial posture.

<img class="common_img" src="../_static/media/chapter_3\section_7\01\media\image9.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3\section_7\01\media\image10.png"  />

* **Program Download**

[Ball Launcher Program.sb3]()

(1) Open WonderCode software <img src="../_static/media/chapter_3\section_7\01\media\image11.png"  />.

(2) Drag the [Ball Launcher Program.sb3]() file located in the same directory as this lesson into WonderCode.

<img class="common_img" src="../_static/media/chapter_3\section_7\01\media\image12.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_7\01\media\image13.png"  />

<img class="common_img" src="../_static/media/chapter_3\section_7\01\media\image14.png"  />

(4) After a successful connection, click <img   src="../_static/media/chapter_3\section_7\01\media\image15.png"  /> on the right side to download the program to MechDog. Wait for the prompt indicating that the download is complete.

<img class="common_img" src="../_static/media/chapter_3\section_7\01\media\image16.png"  />
...
<img class="common_img" src="../_static/media/chapter_3\section_7\02\media\image2.png"   />

* **Program Analysis**

[Intelligent Transport Program.sb3]()
...
<img class="common_img" src="../_static/media/chapter_3\section_7\02\media\image3.png"  />

(2) Set MechDog to move forward with a stride of 120 for 3 seconds. Stride represents the length of one step taken by MechDog, with a value range of -100 to 100 millimeters. A stride less than 0 indicates backward movement, a stride greater than 0 indicates forward movement, and a stride of 0 means stopping.

<img class="common_img" src="../_static/media/chapter_3\section_7\02\media\image4.png"  />

(3) Set the stride and angle to 0 to stop the movement. Delay for 0.5 seconds.

<img class="common_img" src="../_static/media/chapter_3\section_7\02\media\image5.png"  />

(4) After stopping, MechDog sits down.

<img class="common_img" src="../_static/media/chapter_3\section_7\02\media\image6.png"  />

(5) Control the servo to unload the ball.

<img class="common_img" src="../_static/media/chapter_3\section_7\02\media\image7.png"  />

(6) After the unloading action is completed, control the servo to return to the initial position.

<img class="common_img" src="../_static/media/chapter_3\section_7\02\media\image8.png"  />

(7) Return MechDog to its initial posture.

<img class="common_img" src="../_static/media/chapter_3\section_7\02\media\image9.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3\section_7\02\media\image10.png"  />

* **Program Download**

[Intelligent Transport Program.sb3]()

(1) Open WonderCode software <img src="../_static/media/chapter_3\section_7\02\media\image11.png"  />.

(2) Drag the [Intelligent Transport Program.sb3]() file located in the same directory as this lesson into WonderCode.

<img class="common_img" src="../_static/media/chapter_3\section_7\02\media\image12.png"  />

(3) Click on the **“Connect device”** option in the menu bar and select the appropriate COM port (e.g., COM3). Once connected successfully, you will see a **“Connect success”** message.

<img class="common_img" src="../_static/media/chapter_3\section_7\02\media\image13.png"  />

<img class="common_img" src="../_static/media/chapter_3\section_7\02\media\image14.png"  />

(4) After a successful connection, click <img  src="../_static/media/chapter_3\section_7\02\media\image15.png"  /> on the right side to download the program to MechDog. Wait for the prompt indicating that the download is complete.

<img class="common_img" src="../_static/media/chapter_3\section_7\02\media\image16.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image2.png"   />

* **Module Introduction**

The ESP32-S3 Vision Module is a compact camera module that can function as a standalone system.

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image3.png"   />

It captures images using its built-in camera, processes the data with the ESP32 microcontroller, and transmits the information wirelessly via the Wi-Fi module. Supporting multiple communication protocols and low power consumption, it is widely used in various IoT applications.

Module Wiring: Use a 4-pin cable to connect the vision module to the I2C interface 1 on MechDog.

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image4.png"   />

* **Program Analysis**

(1) Initialize MechDog and the ESP32S3 vision module and wait for 2 seconds.

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image5.png"  />

(2) Set the position of servo 9 to 1500, which initializes the tail.

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image6.png"  />

(3) Control MechDog to execute the sitting action group. Start face recognizing after 2 seconds.

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image7.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image8.png"  />

(5) If no face is detected, return the MechDog to its initial status.

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image9.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image10.png"  />
...
② Double-click and open the [flash_download_tool_3.9.7.exe]() file located in [Appendix-> Firmware & Flashing Tools]().

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image11.jpeg"   />

③ Configure the settings in the opened interface according to the diagram below.

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image12.png"   />

④ In the flashing interface, first select the firmware by clicking <img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image13.png"  /> and locate [Face Recognition Firmware & Flashing Tool -&gt;face_detection.bin](). Then configure the settings as shown in the diagram below.

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image14.jpeg"   />

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image15.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image16.jpeg"   />

⑦ Wait for a moment until you see a completion prompt.

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image17.png"  />

⑧ Once the flashing is completed, disconnect the Type-C cable.

(2) Scratch Program Download

[Greeting Puppy Program.sb3]()

① Open WonderCode software <img src="../_static/media/chapter_3/section_7/03/media/image18.png"  style="width:70px" />.

② Drag the [Greeting Puppy Program.sb3]() file located in the same directory as this lesson into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image19.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image20.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image21.png"  />

④ After a successful connection, click <img src="../_static/media/chapter_3/section_7/03/media/image22.png"  /> on the right side to download the program to MechDog. Wait for the prompt indicating that the download is complete.

<img class="common_img" src="../_static/media/chapter_3/section_7/03/media/image23.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/04/media/image2.png"   />

* **Program Analysis**

(1) Initialize MechDog and wait for 1 second.

<img class="common_img" src="../_static/media/chapter_3/section_7/04/media/image3.png"  />

(2) Define a bull horn control function to adjust the position of the bull horns within the range of 0 to 1000.

<img class="common_img" src="../_static/media/chapter_3/section_7/04/media/image4.png"  />

(3) In the main program, first initialize the bull horns. Then repeatedly obtain the distance from the ultrasonic sensor.

<img class="common_img" src="../_static/media/chapter_3/section_7/04/media/image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/04/media/image6.png"  />

(5) Set MechDog to move forward with a stride of 80mm for 1 second to knock down the obstacle.

<img class="common_img" src="../_static/media/chapter_3/section_7/04/media/image7.png"  />

(6) Return the bull horns and MechDog to their initial states.

<img class="common_img" src="../_static/media/chapter_3/section_7/04/media/image8.png"  />

(7) If the distance between the MechDog and the obstacle is greater than 18, control MechDog to move forward.

<img class="common_img" src="../_static/media/chapter_3/section_7/04/media/image9.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3/section_7/04/media/image10.png"  />

* **Program Download**

(1) Open WonderCode software <img src="../_static/media/chapter_3/section_7/04/media/image11.png"  />.

(2) Drag the [Angry Bull Program.sb3]() file located in the same directory as this lesson into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_7/04/media/image12.png"  />

(3) Click on the **“Connect device”** option in the menu bar and select the appropriate COM port (e.g., COM3). Once connected successfully, you will see a “Connect success” message.

<img class="common_img" src="../_static/media/chapter_3/section_7/04/media/image13.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_7/04/media/image14.png"  />

(4) After a successful connection, click <img   src="../_static/media/chapter_3/section_7/04/media/image15.png"  /> on the right side to download the program to MechDog. Wait for the prompt indicating that the download is complete.

<img class="common_img" src="../_static/media/chapter_3/section_7/04/media/image16.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/05/media/image2.png"   />

* **Program Analysis**

(1) Initialize MechDog and the LED dot matrix module, and wait for 1 second.

<img class="common_img" src="../_static/media/chapter_3/section_7/05/media/image3.png"  />

(2) Define a wing control function to control the position of the wings, which ranges from 0 to 1000.

<img class="common_img" src="../_static/media/chapter_3/section_7/05/media/image4.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/05/media/image5.png"  />

(4) If the detected distance is less than 10cm, set the color of the ultrasonic sensor to red.

<img class="common_img" src="../_static/media/chapter_3/section_7/05/media/image6.png"  />

(5) If the detected distance is greater than 50cm, set the color of the ultrasonic sensor to green.

<img class="common_img" src="../_static/media/chapter_3/section_7/05/media/image7.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/05/media/image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/05/media/image9.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3/section_7/05/media/image10.png"  />

* **Program Download**

(1) Open WonderCode software <img  src="../_static/media/chapter_3/section_7/05/media/image11.png"  />.

(2) Drag the [Smart Wing Program.sb3]() file located in the same directory as this lesson into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_7/05/media/image12.png"  />

(3) Click on the **“Connect device”** option in the menu bar and select the appropriate COM port (e.g., COM3). Once connected successfully, you will see a **“Connect success”** message.

<img class="common_img" src="../_static/media/chapter_3/section_7/05/media/image13.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_7/05/media/image14.png"  />

(4) After a successful connection, click <img  src="../_static/media/chapter_3/section_7/05/media/image15.png"  /> on the right side to download the program to MechDog. Wait for the prompt indicating that the download is complete.

<img class="common_img" src="../_static/media/chapter_3/section_7/05/media/image16.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/06/media/image2.png"   />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/06/media/image3.png"  />

(2) In the main program, continuously obtain the distance detected by the ultrasonic sensor.

<img class="common_img" src="../_static/media/chapter_3/section_7/06/media/image4.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/06/media/image5.png"  />

(4) After the object is gripped, control MechDog to move and transport it.

<img class="common_img" src="../_static/media/chapter_3/section_7/06/media/image6.png"  />

(5) Return the robotic arm to its neutral position.

<img class="common_img" src="../_static/media/chapter_3/section_7/06/media/image7.png"  />
...
<img class="common_img" src="../_static/media/chapter_3/section_7/06/media/image8.png"  />

Complete code:

<img class="common_img" src="../_static/media/chapter_3/section_7/06/media/image9.png"  />

* **Program Download**

[Robotic Arm Gripping Program.sb3]()

(1) Open WonderCode software <img src="../_static/media/chapter_3/section_7/06/media/image10.png"  />.

(2) Drag the [Robotic Arm Gripping Program.sb3]() file located in the same directory as this lesson into WonderCode.

<img class="common_img" src="../_static/media/chapter_3/section_7/06/media/image11.png"  />

(3) Click on the **“Connect device”** option in the menu bar and select the appropriate COM port (e.g., COM3). Once connected successfully, you will see a **“Connect success”** message.

<img class="common_img" src="../_static/media/chapter_3/section_7/06/media/image12.png"  />

<img class="common_img" src="../_static/media/chapter_3/section_7/06/media/image13.png"  />

(4) After a successful connection, click <img  src="../_static/media/chapter_3/section_7/06/media/image14.png"  /> on the right side to download the program to MechDog. Wait for the prompt indicating that the download is complete.

<img class="common_img" src="../_static/media/chapter_3/section_7/06/media/image15.png"  />
