...
<img  src="../_static/media/chapter_6/section_1/01/media/image2.png" style="width:48%" />
<img  src="../_static/media/chapter_6/section_1/01/media/image3.png" style="width:48%;" />
</p>
...
<img class="common_img" src="../_static/media/chapter_6\section_1\02\media\image1.png"  />

<img class="common_img" src="../_static/media/chapter_6\section_1\02\media\image2.jpeg"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_1\02\media\image13.png"   />
...
<img class="common_img" src="../_static/media/chapter_6\section_1\02/media/image18.jpeg"  />

## 6.2 Motion Control Lesson

### 6.2.1 Installation of micro:bit Expansion Board

Before experiencing the micro:bit games, please download [MechDog Basic Program]() to MechDog. For specific download instructions, Please refer to download steps in the [4. Python Programming Projects]().

* **Assembly and Wiring**

(1) Remove the expansion bracket of MechDog and prepare to install the micro:bit expansion board.

<img class="common_img" src="../_static/media/chapter_6/section_2/01/media/image2.png"   />

(2) Before installing the micro:bit expansion board, connect one end of the 4-pin cable to the back of the expansion board.

<img class="common_img" src="../_static/media/chapter_6/section_2/01/media/image3.png"   />
...
<img class="common_img" src="../_static/media/chapter_6/section_2/01/media/image4.png"   />
...
<img class="common_img" src="../_static/media/chapter_6/section_2/01/media/image5.png"   />

(5) Reinstall the expansion bracket on MechDog.

<img class="common_img" src="../_static/media/chapter_6/section_2/01/media/image6.png"   />

(6) Connect the other end of the 4-pin cable to interface 1.

<img class="common_img" src="../_static/media/chapter_6\section_2\01/media/image7.png"   />
...
<img class="common_img" src="../_static/media/chapter_6\section_2\02\media\image6.png"  />
...
[Move Forward and Backward Program.hex]()
...
<img class="common_img" src="../_static/media/chapter_6/section_2/03/media/image7.png"  />
...
(1) Click <img src="../_static/media/chapter_6/section_2/03/media/image9.png"  />in the lower left corner of the interface, and select **“Connect Device”**. Follow the pop-up prompt to connect the micro:bit.

<img class="common_img" src="../_static/media/chapter_6/section_2/03/media/image10.png"  />

<img class="common_img" src="../_static/media/chapter_6/section_2/03/media/image11.png"  />

(2) Click **“Download”** in the lower left corner to flash the program.

<img class="common_img" src="../_static/media/chapter_6/section_2/03/media/image12.png"  />
...
<img class="common_img" src="../_static/media/chapter_6/section_2/03/media/image13.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_2\04\media\image6.png"  />
...
(1) Click <img  src="../_static/media/chapter_6\section_2\04\media\image9.png"  />in the lower left corner of the interface, and select **“Connect Device”**. Follow the pop-up prompt to connect the micro:bit.

<img class="common_img" src="../_static/media/chapter_6\section_2\04\media\image10.png"  />

<img class="common_img" src="../_static/media/chapter_6\section_2\04\media\image11.png"  />

(2) Click **“Download”** in the lower left corner to flash the program.

<img class="common_img" src="../_static/media/chapter_6\section_2\04\media\image12.png"  />

(3) After the download is completed, the indicator will stop blinking and keep lighting up. The programming interface will prompt “Downloaded”.

<img class="common_img" src="../_static/media/chapter_6\section_2\04\media\image13.png"  />
...
[Follow a Square Path Program.hex]()
...
<img class="common_img" src="../_static/media/chapter_6\section_2\05\media\image6.png"  />
...
(1) Click <img src="../_static/media/chapter_6\section_2\05\media\image9.png"  />in the lower left corner of the interface, and select **“Connect Device”**. Follow the pop-up prompt to connect the micro:bit.

<img class="common_img" src="../_static/media/chapter_6\section_2\05\media\image10.png"  />

<img class="common_img" src="../_static/media/chapter_6\section_2\05\media\image11.png"  />

(2) Click **“Download”** in the lower left corner to flash the program.

<img class="common_img" src="../_static/media/chapter_6\section_2\05\media\image12.png"  />

(3) After the download is completed, the indicator will stop blinking and keep lighting up. The programming interface will prompt “Downloaded”.

<img class="common_img" src="../_static/media/chapter_6\section_2\05\media\image13.png"  />
...
<img class="common_img" src="../_static/media/chapter_6/section_2/06/media/image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_6/section_2/06/media/image9.png"  />

Finally, the robot stops and the button press flag is cleared.

<img class="common_img" src="../_static/media/chapter_6/section_2/06/media/image10.png"  />

The complete code is shown below:

<img class="common_img" src="../_static/media/chapter_6/section_2/06/media/image11.png"  />

<img class="common_img" src="../_static/media/chapter_6/section_2/06/media/image12.png"  />

<img class="common_img" src="../_static/media/chapter_6/section_2/06/media/image13.png"  />

<img class="common_img" src="../_static/media/chapter_6/section_2/06/media/image14.png"  />

* **Program Download**

[Speed Adjustment Program.hex]()

(1) Click <img src="../_static/media/chapter_6/section_2/06/media/image15.png"  />in the lower left corner of the interface, and select **“Connect Device”**. Follow the pop-up prompt to connect the micro:bit.

<img class="common_img" src="../_static/media/chapter_6/section_2/06/media/image16.png"  />

<img class="common_img" src="../_static/media/chapter_6/section_2/06/media/image17.png"  />

(2) Click **“Download”** in the lower left corner to flash the program.

<img class="common_img" src="../_static/media/chapter_6/section_2/06/media/image18.png"  />

(3) After the download is completed, the indicator will stop blinking and keep lighting up. The programming interface will prompt “Downloaded”.

<img class="common_img" src="../_static/media/chapter_6/section_2/06/media/image19.png"  />
...
[Action Group Execution Program.hex]()

(1) Firstly, initialize MechDog and pause for 2 seconds to allow for initialization to complete.

<img class="common_img" src="../_static/media/chapter_6/section_3/01/media/image2.png"  />

(2) Then, make MechDog execute an action group. Take left kicking as an example.

<img class="common_img" src="../_static/media/chapter_6/section_3/01/media/image3.png"  />

* **Program Download**

[Action Group Execution Program.hex]()

(1) Click <img  src="../_static/media/chapter_6/section_3/01/media/image4.png"  />in the lower left corner of the interface, and select **“Connect Device”**. Follow the pop-up prompt to connect the micro:bit.

<img class="common_img" src="../_static/media/chapter_6/section_3/01/media/image5.png"  />

<img class="common_img" src="../_static/media/chapter_6/section_3/01/media/image6.png"  />

(2) Click “Download” in the lower left corner to flash the program.

<img class="common_img" src="../_static/media/chapter_6/section_3/01/media/image7.png"  />

(3) After the download is completed, the indicator will stop blinking and keep lighting up. The programming interface will prompt “Downloaded”.

<img class="common_img" src="../_static/media/chapter_6/section_3/01/media/image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_6/section_3/02/media/image2.png"   />

* **Program Analysis**

[Light Sensing Program.hex]()
...
<img class="common_img" src="../_static/media/chapter_6/section_3/02/media/image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_6/section_3/02/media/image4.png"  />

(3) When the running status flag is 1, set the flag to 2. Then, make MechDog stop and crouch down.

<img class="common_img" src="../_static/media/chapter_6/section_3/02/media/image5.png"  />

The complete code is shown below:

<img class="common_img" src="../_static/media/chapter_6/section_3/02/media/image6.png"  />

<img class="common_img" src="../_static/media/chapter_6/section_3/02/media/image7.png"  />

* **Program Download**

[Light Sensing Program.hex]()

(1) Click <img src="../_static/media/chapter_6/section_3/02/media/image8.png"  />in the lower left corner of the interface, and select **“Connect Device”**. Follow the pop-up prompt to connect the micro:bit.

<img class="common_img" src="../_static/media/chapter_6/section_3/02/media/image9.png"  />

<img class="common_img" src="../_static/media/chapter_6/section_3/02/media/image10.png"  />

(2) Click **“Download”** in the lower left corner to flash the program.

<img class="common_img" src="../_static/media/chapter_6/section_3/02/media/image11.png"  />

(3) After the download is completed, the indicator will stop blinking and keep lighting up. The programming interface will prompt “Downloaded”.

<img class="common_img" src="../_static/media/chapter_6/section_3/02/media/image12.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\03\media\image4.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\03\media\image7.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\03\media\image10.png"  />

(6) If `action_num` is greater than 3, set it to 1 to start a new round of action execution.

<img class="common_img" src="../_static/media/chapter_6\section_3\03\media\image11.png"  />

Here’s the complete code:

<img class="common_img" src="../_static/media/chapter_6\section_3\03\media\image12.png"  />

<img class="common_img" src="../_static/media/chapter_6\section_3\03\media\image13.png"  />

* **Program Download**

[Sound Control Program.hex]()

(1) Click <img  src="../_static/media/chapter_6\section_3\03\media\image14.png"  />in the lower left corner of the interface, and select **“Connect Device”**. Follow the pop-up prompt to connect the micro:bit.

<img class="common_img" src="../_static/media/chapter_6\section_3\03\media\image15.png"  />

<img class="common_img" src="../_static/media/chapter_6\section_3\03\media\image16.png"  />
...
<img class="common_img" src="../_static/media/chapter_6/section_3/04/media/image6.png"  />

* **Program Download**

[Touch-Sensing Dog Program.hex]()

(1) Click <img class="common_img" src="../_static/media/chapter_6/section_3/04/media/image7.png"  />in the lower left corner of the interface, and select “Connect Device”. Follow the pop-up prompt to connect the micro:bit.

<img class="common_img" src="../_static/media/chapter_6/section_3/04/media/image8.png"  />

<img class="common_img" src="../_static/media/chapter_6/section_3/04/media/image9.png"  />

(2) Click **“Download”** in the lower left corner to flash the program.

<img class="common_img" src="../_static/media/chapter_6/section_3/04/media/image10.png"  />

(3) After the download is completed, the indicator will stop blinking and keep lighting up. The programming interface will prompt “Downloaded”.

<img class="common_img" src="../_static/media/chapter_6/section_3/04/media/image11.png"  />
...
[Temperature Sensing Program.hex]()
...
<img class="common_img" src="../_static/media/chapter_6/section_3/05/media/image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_6/section_3/05/media/image6.png"  />
...
(1) Click <img src="../_static/media/chapter_6/section_3/05/media/image9.png"  />in the lower left corner of the interface, and select “Connect Device”. Follow the pop-up prompt to connect the micro:bit.

<img class="common_img" src="../_static/media/chapter_6/section_3/05/media/image10.png"  />

<img class="common_img" src="../_static/media/chapter_6/section_3/05/media/image11.png"  />

(2) Click “Download” in the lower left corner to flash the program.

<img class="common_img" src="../_static/media/chapter_6/section_3/05/media/image12.png"  />

(3) After the download is completed, the indicator will stop blinking and keep lighting up. The programming interface will prompt “Downloaded”.

<img class="common_img" src="../_static/media/chapter_6/section_3/05/media/image13.png"  />
...
[Guidance Dog Program.hex]()

(1) Turn on MechDog and initialize it. After waiting for 1 second, it will enter the main program.

<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image9.png"  />
...
<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image10.png"  />
...
<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image11.png"  />

(10) If none of the conditions are met, control MechDog to stop and display a heart icon on the LED dot matrix.

<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image12.png"  />

The complete code is shown below:

<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image13.png"  />

<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image14.png"  />

<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image15.png"  />

* **Program Download**

[Guidance Dog Program.hex]()

(1) Click <img  src="../_static/media/chapter_6/section_3/06/media/image16.png"  />in the lower left corner of the interface, and select “Connect Device”. Follow the pop-up prompt to connect the micro:bit.

<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image17.png"  />

<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image18.png"  />

(2) Click **“Download**” in the lower left corner to flash the program.

<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image19.png"  />

(3) After the download is completed, the indicator will stop blinking and keep lighting up. The programming interface will prompt “Downloaded”.

<img class="common_img" src="../_static/media/chapter_6/section_3/06/media/image20.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image2.png"   />

* **Program Analysis**

[Gravity Control Program.hex]()

(1) Initialize the MechDog hardware and display a "heart" icon after waiting for 1 second.

<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image4.png"  />

(3) Check if the micro:bit board is tilted to the right from your point of view, facing MechDog.

<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image6.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image7.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image8.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image9.png"  />

Here is the complete code:

<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image10.png"  />

<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image11.png"  /><img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image12.png"  /><img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image13.png"  />

* **Program Download**

[Gravity Control Program.hex]()

(1) Click <img   src="../_static/media/chapter_6\section_3\07\media\image14.png"  />in the lower left corner of the interface, and select “Connect Device”. Follow the pop-up prompt to connect the micro:bit.

<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image15.png"  />

<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image16.png"  />

(2) Click **“Download”** in the lower left corner to flash the program.

<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image17.png"  />

(3) After the download is completed, the indicator will stop blinking and keep lighting up. The programming interface will prompt “Downloaded”.

<img class="common_img" src="../_static/media/chapter_6\section_3\07\media\image18.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image2.png"   />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image3.png"  />

② Create a task to receive data sent by the simulated bone.

<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image4.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image5.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image6.png"  />

⑤ Execute action group 3 to make MechDog return to its initial posture. Calculate the difference in signal strength.

<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image7.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image8.png"  />

⑦ If the difference is less than 0, control MechDog to turn left for two seconds.

<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image9.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image10.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image11.png"  />

② In the main program, send string data every 50ms for wireless signal transmission.

<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image12.png"  />

* **Program Download**

(1) Download Action Group

[Action Group File & PC Software]()

① Open the PC software <img  src="../_static/media/chapter_6\section_3\08\media\image13.png"  /> and connect to the robot.

② Click the **"Open Action File"** button in the action group settings area. Open the "**1.rob"** action group.

<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image14.png"  />

<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image15.png"  />

③ Select action group number **"1"**. Click **"Download"** to save the **"1.rob"** action group to the action group 1.

<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image16.png"  />

④ Then, download **"2.rob"** and **"3.rob"** to the action groups 2 and 3 respectively.

<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image17.png"  />
...
① Click <img src="../_static/media/chapter_6\section_3\08\media\image18.png"  />in the lower left corner of the interface, and select **“Connect Device”**. Follow the pop-up prompt to connect the micro:bit.

<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image19.png"  />

<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image20.png"  />

② Click **“Download”** in the lower left corner to flash the program.

<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image21.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_3\08\media\image22.png"  />
...
<img class="common_img" src="../_static/media/chapter_6/section_4/01/media/image2.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_4\01/media/image3.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_4\02\media\image12.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_4\02\media\image17.png"  />
...
<img class="common_img" src="../_static/media/chapter_6\section_4\02\media\image23.png"  />
