...
(2) Locate and open the [ESP32S3 Program Download -> 01 FaceDetection -> FaceDetection.ino]() program file in the same directory as this section.

<img src="../_static/media/chapter_9/section_2/01/media/image2.png" class="common_img" />

(3) Select the `ESP32S3 Dev Module` development board.

<img src="../_static/media/chapter_9/section_2/01/media/image3.png" class="common_img" />

(4) Click the `Tool` in the menu bar, and select the corresponding configuration for the ESP32S3 development board.

<img src="../_static/media/chapter_9/section_2/01/media/image4.png" class="common_img" />

(5) Click <img src="../_static/media/chapter_9/section_2/01/media/image5.png" /> to download the program to the ESP32S3, and then wait for the download to complete.

<img src="../_static/media/chapter_9/section_2/01/media/image3.png" class="common_img" /><img src="../_static/media/chapter_9/section_2/01/media/image6.png" class="common_img" />
...
(1) Open the `Hiwonder Python Editor` software <img src="../_static/media/chapter_9/section_2/02/media/image2.png" />.
...
<img src="../_static/media/chapter_9/section_2/02/media/image3.png" class="common_img" />

(3) Click the connection button <img src="../_static/media/chapter_9/section_2/02/media/image4.png" /> in the menu bar; it will change to a green icon <img src="../_static/media/chapter_9/section_2/02/media/image5.png" /> once connected successfully.

(4) After successfully connecting, click the download button <img src="../_static/media/chapter_9/section_2/02/media/image6.png" /> in the menu bar to download the program to MechDog. Wait for the information interaction box below to indicate that the download is complete.

<img src="../_static/media/chapter_9/section_2/02/media/image7.png" class="common_img" />
...
Apple users: Search for [IoT Control]() directly in the App Store and download it.

Android users: Locate the  [IoT Control]()  installation pack in the same directory as this lesson. Install it to your phone.
...
<img src="../_static/media/chapter_9/section_3/media/image2.jpeg" class="common_img" />

(2) Tap the flashing icon <img src="../_static/media/chapter_9/section_3/media/image3.png" /> in the upper right corner to connect to the WiFi named `MechDog_wifi`

<img src="../_static/media/chapter_9/section_3/media/image4.jpeg" class="common_img" />

(3) After the connection is successful, the icon <img src="../_static/media/chapter_9/section_3/media/image3.png" /> remains on.
...
|:--:|:--|
| <img src="../_static/media/chapter_9/section_3/media/image6.png" class="common_img" /> | Once MechDog's vision module recognizes a face, the phone will vibrate.<br/><br/>**Note**: Before experiencing this game, please download the face recognition program in the vision module. |
| <img src="../_static/media/chapter_9/section_3/media/image7.png" class="common_img" /> | When MechDog's glowy ultrasonic sensor detects an object, the buzzer will sound. |
| <img src="../_static/media/chapter_9/section_3/media/image8.png" class="common_img" /> | When an unidentified object impacts the MechDog, the buzzer will sound. |
| <img src="../_static/media/chapter_9/section_3/media/image9.png" class="common_img" /> | Once enabling the function, the buzzer will continue to sound. |
| <img src="../_static/media/chapter_9/section_3/media/image10.png" class="common_img" /> | When MechDog's vision module recognizes a color, the corresponding color will be displayed within the lower circle.<br/><br/>**Note**: Before experiencing this game, please download the color recognition program in the vision module. |
| <img src="../_static/media/chapter_9/section_3/media/image11.png" class="common_img" /> | After enabling this function, the detected distance will be displayed below. |
| <img src="../_static/media/chapter_9/section_3/media/image12.png" class="common_img" /> | Control the color of the glowy ultrasonic sensor. |
| <img src="../_static/media/chapter_9/section_3/media/image13.png" class="common_img" /> | Control MechDog to execute different action groups. |
...
<img src="../_static/media/chapter_9/section_4/media/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_4/media/image3.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_4/media/image4.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_4/media/image5.png" class="common_img" />

(3) Select the `ESP32S3 Dev Module` development board.

<img src="../_static/media/chapter_9/section_4/media/image6.png" class="common_img" />

(4) Click the `Tool` in the menu bar, and select the corresponding configuration for the ESP32S3 development board.

<img src="../_static/media/chapter_9/section_4/media/image7.png" class="common_img" />

(5) Click <img src="../_static/media/chapter_9/section_4/media/image8.png" /> to download the program to the ESP32S3, and then wait for the download to complete.
...
<img src="../_static/media/chapter_9/section_5/media/image2.png" class="common_img" />

### 9.5.3 Glowy Ultrasonic Sensor

<img src="../_static/media/chapter_9/section_5/media/image3.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_5/media/image6.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_6/media/image2.png" class="common_img" />

### 9.6.3 IMU Sensor

<img src="../_static/media/chapter_9/section_6/media/image3.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_7/media/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_7/media/image3.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_7/media/image4.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_7/media/image5.png" class="common_img" />

(3) Select the `ESP32S3 Dev Module` development board.

<img src="../_static/media/chapter_9/section_7/media/image6.png" class="common_img" />

(4) Click the `Tool` in the menu bar, and select the corresponding configuration for the ESP32S3 development board.

<img src="../_static/media/chapter_9/section_7/media/image7.png" class="common_img" />

(5) Click <img src="../_static/media/chapter_9/section_7/media/image8.png" /> to download the program to the ESP32S3, and then wait for the download to complete.

<img src="../_static/media/chapter_9/section_7/media/image6.png" class="common_img" />

<img src="../_static/media/chapter_9/section_7/media/image9.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_8/media/image2.png" class="common_img" />

### 9.8.3 Glowy Ultrasonic Sensor

<img src="../_static/media/chapter_9/section_8/media/image3.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_9/media/image2.png" class="common_img" />

### 9.9.3 Glowy Ultrasonic Sensor

<img src="../_static/media/chapter_9/section_9/media/image3.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_10/media/image2.png" class="common_img" />

### 9.10.3 Buzzer

<img src="../_static/media/chapter_9/section_10/media/image3.png" class="common_img" />
...
<img src="../_static/media/chapter_9/section_11/media/image2.png" class="common_img" />
