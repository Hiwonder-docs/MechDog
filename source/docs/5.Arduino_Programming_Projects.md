...
[IDE Installation Package & ESP32 Development Package](https://drive.google.com/drive/folders/1wJZCIvGLD6YQFeU7hys8D1eYQOjPmz6O?usp=sharing)
...
(2) In the pop-up window, navigate to the [MechDog_Arduino.zip](https://drive.google.com/drive/folders/1wJZCIvGLD6YQFeU7hys8D1eYQOjPmz6O?usp=sharing) file (you can find this file in the [IDE Installation Package & ESP32 Development Package](https://drive.google.com/drive/folders/1wJZCIvGLD6YQFeU7hys8D1eYQOjPmz6O?usp=sharing) folder located in the same directory as this document), then click `Open`
...
<img src="../_static/media/chapter_3/section_2/02/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_2/03/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_2/03/image13.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_2/04/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_2/04/image14.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_2/05/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_2/06/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_2/06/image12.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_2/07/image2.png" class="common_img" />
...
(1) Locate the [Walking Height Adjustment Program->change_body_height->change_body_height.ino](../_static/source_code/Arduino%20Programming%20Projects.zip) file.
...
<img src="../_static/media/chapter_3/section_2/08/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_3/02/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_3/02/image3.png" class="common_img" style="width:350px;"/>
...
<img src="../_static/media/chapter_3/section_3/03/image2.png" class="common_img" />
...
<p id="anchor_5_3_3_program_download"></p>
...
<img class="common_img" src="../_static/media/chapter_5/section_3/04/image3.png"  style="width:350px;" />
...
<img class="common_img" src="../_static/media/chapter_5/section_3/04/image11.png"  />
...
<img src="../_static/media/chapter_3/section_3/05/image2.png" class="common_img" />
...
<p id="anchor_5_3_5_program_download"></p>
...
<img src="../_static/media/chapter_3/section_3/06/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_3/07/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_4/section_3/07/image9.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_4/03/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_4/04/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_4/04/image11.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_4/05/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_5/02/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_5/02/image3.png" class="common_img" style="width:450px;"/>
...
<img src="../_static/media/chapter_5/section_5/02/image4.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_5/02/image5.png" class="common_img" style="width:350px;"/>
...
[Color Recognition Program](../_static/source_code/Arduino%20Programming%20Projects.zip)
...
<img src="../_static/media/chapter_5/section_5/02/image14.png" class="common_img" />

(3) Select the `ESP32S3 Dev Module` development board.

<img src="../_static/media/chapter_5/section_5/02/image15.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_5/02/image16.png" class="common_img" />

⑤ Click the upload button to upload the code to the ESP32-S3, and wait for the flashing process to complete.

<img src="../_static/media/chapter_5/section_5/02/image18.png" class="common_img" />

<img src="../_static/media/chapter_5/section_5/02/image19.png" class="common_img" />

(2) Arduino Program Download

[Color Recognition Program](../_static/source_code/Arduino%20Programming%20Projects.zip)

① Find the file [color_recognition->color_recognition.ino](../_static/source_code/Arduino%20Programming%20Projects.zip) in the same path as this document.

<img src="../_static/media/chapter_5/section_5/02/image20.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_5/02/image21.png" class="common_img" />

③ Click the upload button to download the program to MechDog and wait for the download to complete.

<img src="../_static/media/chapter_5/section_5/02/image23.png" class="common_img" />

<img src="../_static/media/chapter_5/section_5/02/image24.png" class="common_img" />
...
(2) Run the Program: After making these modifications, follow the instructions in "[**Arduino Program Download**](../_static/source_code/Arduino%20Programming%20Projects.zip)" to run the program.
...
<img src="../_static/media/chapter_3/section_5/03/image2.png" class="common_img" />

* **Module Introduction**

The ESP32-S3 Vision Module is a compact camera module that can function as a standalone system.

<img src="../_static/media/chapter_5/section_5/03/image3.png" class="common_img" style="width:450px;"/>
...
<img src="../_static/media/chapter_5/section_5/03/image4.png" class="common_img" />

* **Example Program** 

[Color Tracking Program](../_static/source_code/Arduino%20Programming%20Projects.zip)
...
<img src="../_static/media/chapter_5/section_5/03/image16.png" class="common_img" />

③ Select the `ESP32S3 Dev Module` development board.

<img src="../_static/media/chapter_5/section_5/03/image17.png" class="common_img" />

④ Click on the `Tools` in the menu bar, and select the corresponding ESP32S3 development board configuration as shown in the figure below (configuration is required for the first use, and no further configuration is needed for subsequent uses).

<img src="../_static/media/chapter_5/section_5/03/image18.png" class="common_img" />

⑤ Click the upload button to upload the code to the ESP32-S3, and wait for the flashing process to complete.

<img src="../_static/media/chapter_5/section_5/03/image20.png" class="common_img" />

<img src="../_static/media/chapter_5/section_5/03/image21.png" class="common_img" />

(2) Arduino Program Download

[Color Tracking Program](../_static/source_code/Arduino%20Programming%20Projects.zip)

① Find the file [Color Tracking Program->color_follow->color_follow.ino](../_static/source_code/Arduino%20Programming%20Projects.zip) in the same path as this document.

<img src="../_static/media/chapter_5/section_5/03/image22.png" class="common_img" />

② Connect MechDog to the computer via a USB data cable, click on the `Select Board` option, and the software will automatically detect the current ESP32 port. Click to connect.

<img src="../_static/media/chapter_5/section_5/03/image23.png" class="common_img" />

③ Click the upload button to download the program to MechDog and wait for the download to complete.

<img src="../_static/media/chapter_5/section_5/03/image25.png" class="common_img" />

<img src="../_static/media/chapter_5/section_5/03/image26.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_5/03/image27.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_5/03/image28.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_5/03/image29.png" class="common_img" />

<img src="../_static/media/chapter_5/section_5/03/image30.png" class="common_img" />

(4) Then save the HSV threshold values. Open the file [color_detection.cpp](../_static/source_code/Arduino%20Programming%20Projects.zip) in the same directory as this document, and modify the color data to match the saved HSV array. The six elements of the color data, from left to right, are: **H lower limit, H upper limit, S lower limit, S upper limit, V lower limit, and V upper limit**. Finally, refer to "**Color Recognition Program Download**" to upload the modified program to the ESP32S3-Cam.

<img src="../_static/media/chapter_5/section_5/03/image31.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_5/04/image2.png" class="common_img" />

* **Module Introduction**

The ESP32-S3 Vision Module is a compact camera module that can function as a standalone system.

<img src="../_static/media/chapter_5/section_5/04/image3.png" class="common_img" style="width:450px;"/>
...
<img src="../_static/media/chapter_5/section_5/04/image4.png" class="common_img" />
...
② Open [Firmware & Flashing Tools->LineTracking.ino](resources_download.md) located in the same directory.

<img src="../_static/media/chapter_5/section_5/04/image10.png" class="common_img" />

③ Select the `ESP32S3 Dev Module` development board.

<img src="../_static/media/chapter_5/section_5/04/image11.png" class="common_img" />

④ Click on the `Tools` in the menu bar, and select the corresponding ESP32S3 development board configuration as shown in the figure below (configuration is required for the first use, and no further configuration is needed for subsequent uses).

<img src="../_static/media/chapter_5/section_5/04/image12.png" class="common_img" />

⑤ Click the upload button to upload the code to the ESP32-S3, and wait for the flashing process to complete.

<img src="../_static/media/chapter_5/section_5/04/image14.png" class="common_img" />

<img src="../_static/media/chapter_5/section_5/04/image15.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_5/04/image16.png" class="common_img" />

② After opening the file, select the correct board model as shown in the image below:

<img src="../_static/media/chapter_5/section_5/04/image17.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_5/04/image18.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_5/04/image19.png" class="common_img" />
...
(3) Execute the Program: After making the modifications, refer to the instructions in "[**Arduino Program Download**](../_static/source_code/Arduino%20Programming%20Projects.zip)" to run the program.
...
<img src="../_static/media/chapter_3/section_5/05/image2.png" class="common_img" />

* **Module Introduction**

The ESP32-S3 Vision Module is a compact camera module that can function as a standalone system.

<img src="../_static/media/chapter_5/section_5/05/image3.png" class="common_img" style="width:450px;"/>
...
<img src="../_static/media/chapter_5/section_5/05/image4.png" class="common_img" />

* **Example Program** 

[Face Recognition Program](../_static/source_code/Arduino%20Programming%20Projects.zip)
...
<p id="anchor_5_5_5_program_download"></p>
...
② Open [ESP32-S3 Face Recognition->FaceDetection.ino](../_static/source_code/ESP32-S3%20Face%20Recognition%20Program.zip) located in the same directory.

<img src="../_static/media/chapter_5/section_5/05/image9.png" class="common_img" />

③ Select the `ESP32S3 Dev Module` development board.

<img src="../_static/media/chapter_5/section_5/05/image10.png" class="common_img" />

④ Click on the `Tools` in the menu bar, and select the corresponding ESP32S3 development board configuration as shown in the figure below (configuration is required for the first use, and no further configuration is needed for subsequent uses).

<img src="../_static/media/chapter_5/section_5/05/image11.png" class="common_img" />

⑤ Click the upload button to upload the code to the ESP32-S3, and wait for the flashing process to complete.

<img src="../_static/media/chapter_5/section_5/05/image13.png" class="common_img" />

<img src="../_static/media/chapter_5/section_5/05/image14.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_5/05/image15.png" class="common_img" />

② After opening the file, choose the appropriate board model, as depicted in the image below.

<img src="../_static/media/chapter_5/section_5/05/image16.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_5/05/image17.png" class="common_img" />
...
(3) After making the modifications, follow the instructions in "**[Program Download](#anchor_5_5_5_program_download)**" to execute the program.
...
<img src="../_static/media/chapter_5/section_6/01/image2.png" class="common_img" />
...
:::{Note}
This section requires the MechDog slave device program to be downloaded beforehand. Please download the [MechDog slave device program](../_static/source_code/Arduino%20Programming%20Projects.zip) located in the same directory as this document.
:::
...
<img src="../_static/media/chapter_5/section_6/02/image2.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_6/02/image3.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_6/02/image4.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_6/02/image5.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_6/02/image6.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_6/02/image7.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_6/02/image8.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_6/02/image9.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_6/02/image10.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_6/02/image11.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_6/02/image12.png" class="common_img" />

After sending the command, MechDog will return the requested data in the format: `CMD|function code|data|$`, where `data` contains the retrieved information.

<img src="../_static/media/chapter_5/section_6/02/image13.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_7/01/image2.png" class="common_img" />

* **Program Analysis** 

[Ball Launcher Program](../_static/source_code/Arduino%20Programming%20Projects.zip)
...
<img src="../_static/media/chapter_5/section_7/01/image10.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_7/01/image11.png" class="common_img" />

(3) Click the upload button to upload the program to MechDog and wait for the download to finish.

<img src="../_static/media/chapter_5/section_7/01/image13.png" class="common_img" />

<img src="../_static/media/chapter_5/section_7/01/image14.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_7/02/image2.png" class="common_img" />

* **Program Analysis** 

[Intelligent Transport Program](../_static/source_code/Arduino%20Programming%20Projects.zip)
...
<img src="../_static/media/chapter_5/section_7/02/image10.png" class="common_img" />

(2) Connect MechDog to your computer with a USB data cable, then click on the `Select Board` option. The software will automatically detect the current ESP32 serial port; click to connect.

<img src="../_static/media/chapter_5/section_7/02/image11.png" class="common_img" />

(3) Click the upload button to upload the program to MechDog and wait for the download to finish.

<img src="../_static/media/chapter_5/section_7/02/image13.png" class="common_img" />

<img src="../_static/media/chapter_5/section_7/02/image14.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_7/03/image2.png" class="common_img" />

* **Module Introduction**

The ESP32-S3 Vision Module is a compact camera module that can function as a standalone system.

<img src="../_static/media/chapter_5/section_7/03/image3.png" class="common_img" style="width:450px;"/>

It captures images using its built-in camera, processes the data with the ESP32 microcontroller, and transmits the information wirelessly via the Wi-Fi module. Supporting multiple communication protocols and low power consumption, it is widely used in various IoT applications.

Module Wiring: Use a 4-pin cable to connect the vision module to the I2C interface 1 on MechDog.

<img src="../_static/media/chapter_5/section_7/03/image4.png" class="common_img" />

* **Program Analysis**

[Greeting Puppy Program](../_static/source_code/Arduino%20Programming%20Projects.zip)
...
② Double-click and open the **flash_download_tool_3.9.7.exe** file located in [Face Recognition Firmware->Firmware & Flashing Tools->flash_download_tool_3.9.7](resources_download.md)

<img src="../_static/media/chapter_5/section_7/03/image9.jpeg" class="common_img" />

③ Configure the settings in the opened interface according to the diagram below.

<img src="../_static/media/chapter_5/section_7/03/image10.png" class="common_img" />

④ In the flashing interface, first select the firmware by clicking the browse button and locate [Face Recognition Firmware & Flashing Tool->face_detection.bin](resources_download.md). Then configure the settings as shown in the diagram below.

<img src="../_static/media/chapter_5/section_7/03/image12.png" class="common_img" />

<img src="../_static/media/chapter_5/section_7/03/image13.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_7/03/image14.jpeg" class="common_img" />

⑦ Wait for a moment until you see a completion prompt.

<img src="../_static/media/chapter_5/section_7/03/image15.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_7/03/image16.png" class="common_img" />
...
<img src="../_static/media/chapter_5/section_7/03/image17.png" class="common_img" />

③ Click the upload button to upload the program to MechDog and wait for the download to finish.

<img src="../_static/media/chapter_5/section_7/03/image19.png" class="common_img" />

<img src="../_static/media/chapter_5/section_7/03/image20.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_7/04/image2.png" class="common_img" />

* **Program Analysis** 

[Angry Bull Program](../_static/source_code/Arduino%20Programming%20Projects.zip)
...
<img src="../_static/media/chapter_5/section_7/04/image8.png" class="common_img" />

(2) Connect MechDog to your computer with a USB data cable, then click on the `Select Board` option. The software will automatically detect the current ESP32 serial port; click to connect.

<img src="../_static/media/chapter_5/section_7/04/image9.png" class="common_img" />

(3) Click the upload button to upload the program to MechDog and wait for the download to finish.

<img src="../_static/media/chapter_5/section_7/04/image11.png" class="common_img" />

<img src="../_static/media/chapter_5/section_7/04/image12.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_7/05/image2.png" class="common_img" />

* **Program Analysis** 

[Smart Wing Program](../_static/source_code/Arduino%20Programming%20Projects.zip)
...
<img src="../_static/media/chapter_5/section_7/05/image8.png" class="common_img" />

(2) Connect MechDog to your computer with a USB data cable, then click on the `Select Board` option. The software will automatically detect the current ESP32 serial port; click to connect.

<img src="../_static/media/chapter_5/section_7/05/image9.png" class="common_img" />

(3) Click the upload button to upload the program to MechDog and wait for the download to finish.

<img src="../_static/media/chapter_5/section_7/05/image11.png" class="common_img" />

<img src="../_static/media/chapter_5/section_7/05/image12.png" class="common_img" />
...
<img src="../_static/media/chapter_3/section_7/06/image2.png" class="common_img" />

* **Program Analysis** 

[Robotic Arm Gripping Program](../_static/source_code/Arduino%20Programming%20Projects.zip)
...
<img src="../_static/media/chapter_5/section_7/06/image10.png" class="common_img" />

(2) Connect MechDog to your computer with a USB data cable, then click on the `Select Board` option. The software will automatically detect the current ESP32 serial port; click to connect.

<img src="../_static/media/chapter_5/section_7/06/image11.png" class="common_img" />

(3) Click the upload button to upload the program to MechDog and wait for the download to finish.

<img src="../_static/media/chapter_5/section_7/06/image13.png" class="common_img" />

<img src="../_static/media/chapter_5/section_7/06/image14.png" class="common_img" />
