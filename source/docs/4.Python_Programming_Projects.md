...
(1) Open the **'Hiwonder Python Editor'** software <img   src="../_static/media/chapter_4/section_3/04/media/image10.png" width="70px"/>.
...
(3) Click the connection button <img   src="../_static/media/chapter_4/section_3/04/media/image12.png" width="70px"/> in the menu bar; it will change to a green icon <img  src="../_static/media/chapter_4/section_3/04/media/image13.png" width="70px"/> once connected successfully.

(4) After successfully connecting, click the download button <img   src="../_static/media/chapter_4/section_3/04/media/image14.png" width="70px" /> in the menu bar to download the program to MechDog. Wait for the information interaction box below to indicate that the download is complete.
...
① Open the **'Hiwonder Python Editor'** software <img  src="../_static/media/chapter_4\section_7\03\media\image18.png" width="70px"  />.

② Drag the 'main.py' file, located in the same directory as this document, into the Hiwonder Python Editor (make sure to drag it into the red box area for it to be effective).

<img class="common_img" src="../_static/media/chapter_4\section_7\03\media\image19.png"  />

③ Click the connection button <img  src="../_static/media/chapter_4\section_7\03\media\image20.png" width="70px" /> in the menu bar; it will change to a green icon <img  src="../_static/media/chapter_4\section_7\03\media\image21.png" width="70px" /> once connected successfully.

④ After successfully connecting, click the download button <img  src="../_static/media/chapter_4\section_7\03\media\image22.png" width="70px" /> in the menu bar to download the program to MechDog. Wait for the information interaction box below to indicate that the download is complete.
